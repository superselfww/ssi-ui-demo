...
export default function ViewQuizessOnSchool() {
    const [tab, setTab] = useState("details");
    return (
        <MainWrapper logged={true}>
            <MainTitle title="Quiz Details" buttons={[{ label: "Back"}]} />
                    ...
                    <div className="p-6">
                        ...
                        <div className="mb-4">
                            ...
                            {submissions.slice(0,4).map((s, i) => (
                                <Link to={`/classes/:id/quizzes/view/:id/:id`} key={i} className="flex items-center gap-3 mb-3 bg-white rounded-xl shadow-sm px-3 py-2">
